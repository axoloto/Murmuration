...
std::vector<Math::float3> ParticleEmitter::getParticlesPos() const
{
  ...
  if (m_dimension == Dimension::dim2D)
  {
    ...
    Math::float3 start2D = { 0.0f, m_origin.y - m_halfSideLength, m_origin.z - m_halfSideLength };
    Math::float3 end2D = { 0.0f, m_origin.y + m_halfSideLength, m_origin.z + m_halfSideLength };
  ...
  else if (m_dimension == Dimension::dim3D)
  {
    ...
    Math::float3 start3D = { m_origin.x - m_halfSideLength, m_origin.y - m_halfSideLength, m_origin.z - m_halfSideLength };
    Math::float3 end3D = { m_origin.x + m_halfSideLength, m_origin.y + m_halfSideLength, m_origin.z + m_halfSideLength };
